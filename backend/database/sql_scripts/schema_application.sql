...
INSERT INTO "users" (id, username, first_name, last_name, email, role, clerk_id) VALUES
(1, 'lamdao', 'Lam', 'Dao', 'lam.dao@edu.sait.ca', 'member','user_33TygiU42yjY3nfWxD5cEPCACv7')
ON CONFLICT (clerk_id) DO NOTHING;

INSERT INTO resume (user_id, summary, skills, experience, education, certifications, additional_info) VALUES
(2, 'Detail-oriented data analyst with expertise in data visualization and statistical analysis.', 'R, Python, Tableau', '3 years at DataInsights as a Data Analyst', 'M.Sc. in Data Science from University Y', 'Certified Data Analyst', 'Looking for remote opportunities.');
...
(1,2, NULL, NULL, 'I', 'Jane', 'Doe', 'janeD@sample.com', '555-555-5555', ARRAY['Answer A', 'Answer B', 'Answer C', 'Answer D']),
(2,2, NULL, NULL, 'U', 'Bob', 'Smith', 'bobS@sample.com', '987-654-3210', ARRAY['Answer A', 'Answer B', 'Answer C', 'Answer D']);
