...
(7, 'Lam', 'Dao', 'lam.dao@edu.sait.ca', 'member')
...
(    7, 'Detail-oriented data analyst with expertise in data visualization and statistical analysis.', 'R, Python, Tableau', '3 years at DataInsights as a Data Analyst', 'M.Sc. in Data Science from University Y', 'Certified Data Analyst', 'Looking for remote opportunities.');
...
(1, 11111, NULL, NULL, 'S', 'Alice', 'Johnson', 'aliceJ@sample.com', '123-456-7890', ARRAY['Answer 1', 'Answer 2', 'Answer 3', 'Answer 4']),
(1,     7, NULL, NULL, 'I', 'Jane', 'Doe', 'janeD@sample.com', '555-555-5555', ARRAY['Answer A', 'Answer B', 'Answer C', 'Answer D']),
(2,     7, NULL, NULL, 'U', 'Bob', 'Smith', 'bobS@sample.com', '987-654-3210', ARRAY['Answer A', 'Answer B', 'Answer C', 'Answer D']);
