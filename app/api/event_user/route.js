...
// GET /api/event_user
// Fetch all event registrations (admin use)
...
// POST /api/event_user
// Register a user for an event — expects { eventId, userId }
...
// Cancel a registration — expects { eventId, userId }
export async function DELETE(req) {
  try {
    ...
    const result = await cancelEventUserController(
      Number(eventId),
      Number(userId)
    );
